...
const LoginModal = (props) => {
  ...
  const handleNaverLogin = () => {
    ...
    window.location.href = `http://localhost:5000/auth/naver?redirectUrl=${encodedUrl}`;
  };
  ...
  const handleKakaoLogin = () => {
    ...
    window.location.href = `http://localhost:5000/auth/kakao?redirectUrl=${encodedUrl}`;
  };
  ...
  const handleGoogleLogin = () => {
    ...
    window.location.href = `http://localhost:5000/auth/google?redirectUrl=${encodedUrl}`;
  };
  ...
  const handleGithubLogin = () => {
    ...
    window.location.href = `http://localhost:5000/auth/github?redirectUrl=${encodedUrl}`;
  };
